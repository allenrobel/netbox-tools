...
[ip_address_delete] | Delete an ip address using command line options ``--ip``
...
[ip_address_delete]: https://github.com/allenrobel/netbox-tools/blob/master/scripts/ip_address_delete.py
